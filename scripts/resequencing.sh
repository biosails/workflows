...
#
# Generated at: 2016-11-16T13:45:58
...
#
# Variables 
# Indir: /scratch/gencore/templates_git/data/processed
# Outdir: /scratch/gencore/templates_git/data/analysis/bowtie2
# Local Variables:
...
#TASK tags=Sample_5
mkdir -p /scratch/gencore/templates_git/data/analysis/Sample_5/bowtie2 && \
...
-1 /scratch/gencore/templates_git/data/processed/Sample_5/trimmomatic/Sample_5_read1_trimmomatic_1PE.gz \
-2 /scratch/gencore/templates_git/data/processed/Sample_5/trimmomatic/Sample_5_read2_trimmomatic_2PE.gz \
-S /scratch/gencore/templates_git/data/analysis/Sample_5/bowtie2/Sample_5_aligned.sam
...
#
# Variables 
# Indir: /scratch/gencore/templates_git/data/analysis/bowtie2
# Outdir: /scratch/gencore/templates_git/{$self->samtools}
# Local Variables:
...
#TASK tags=Sample_5
mkdir -p /scratch/gencore/templates_git/data/analysis/Sample_5/samtools && \
    samtools view -b -S /scratch/gencore/templates_git/data/analysis/Sample_5/bowtie2/Sample_5_aligned.sam \
    > /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_aligned.bam
...
#
# Variables 
# Indir: /scratch/gencore/templates_git/data/analysis/samtools_view
# Outdir: /scratch/gencore/templates_git/data/analysis/remove_SAM
# Local Variables:
#	create_outdir: 0
#	before_meta: HPC DIRECTIVES
#
...
#TASK tags=Sample_5
rm -rf /scratch/gencore/templates_git/data/analysis/Sample_5/bowtie2/Sample_5_aligned.sam
...
#
# Variables 
# Indir: /scratch/gencore/templates_git/{$self->samtools}
# Outdir: /scratch/gencore/templates_git/{$self->picard}
# Local Variables:
#	indir: {$self->samtools}
#	outdir: {$self->picard}
#	INPUT: {$self->samtools_dir}/{$sample}_aligned.bam
...
#TASK tags=Sample_5
mkdir -p /scratch/gencore/templates_git/data/analysis/Sample_5/picard && \
picard -Xmx2g CleanSam \
    INPUT=/scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_aligned.bam \
    O=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_cleaned.aligned.bam \
    TMP_DIR=/scratch/gencore/templates_git/data/analysis/Sample_5/bowtie2/tmp
...
#
# Variables 
# Indir: /scratch/gencore/templates_git/{$self->picard}
# Outdir: /scratch/gencore/templates_git/{$self->picard}
# Local Variables:
#	indir: {$self->picard}
#	outdir: {$self->picard}
...
picard -Xmx2g  SortSam \
    INPUT=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_cleaned.aligned.bam \
    O=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_csorted.cleaned.aligned.bam \
    SO=coordinate \
    TMP_DIR=/scratch/gencore/templates_git/data/analysis/Sample_5/bowtie2/tmp
...
picard -Xmx2g CollectMultipleMetrics \
    TMP_DIR=/scratch/gencore/templates_git/data/analysis/Sample_5/bowtie2/tmp \
    I=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_csorted.cleaned.aligned.bam \
    O=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_collmulmetr.csorted.cleaned.aligned \
...
picard -Xmx2g AddOrReplaceReadGroups \
    I=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_csorted.cleaned.aligned.bam \
    O=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_withrg.csorted.cleaned.aligned.bam \
...
picard -Xmx2g BuildBamIndex \
    I=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_withrg.csorted.cleaned.aligned.bam \
    TMP_DIR=/scratch/gencore/templates_git/data/analysis/Sample_5/bowtie2/tmp
...
picard -Xmx2g MarkDuplicates \
    M=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_markDup_metrics_file.txt \
    I=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_withrg.csorted.cleaned.aligned.bam \
    O=/scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_mdup.withrg.csorted.cleaned.aligned.bam \
...
# Variables 
# Indir: /scratch/gencore/templates_git/{$self->picard}
# Outdir: /scratch/gencore/templates_git/{$self->gatk}
# Local Variables:
#	indir: {$self->picard}
#	outdir: {$self->gatk}
...
#TASK tags=Sample_5
mkdir -p /scratch/gencore/templates_git/data/analysis/Sample_5/gatk && \
gatk -T RealignerTargetCreator \
    ...
    -I /scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_withrg.csorted.cleaned.aligned.bam \
    -o /scratch/gencore/templates_git/data/analysis/Sample_5/gatk/Sample_5_realignment_targets.list
...
gatk -T IndelRealigner \
     -R /scratch/Reference_Genomes/Public/Vertebrate_mammalian/Homo_sapiens/ENSEMBL-release-81-GRCh38/Homo_sapiens.GRCh38.dna.toplevel.fa \
     -I /scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_withrg.csorted.cleaned.aligned.bam \
     -targetIntervals /scratch/gencore/templates_git/data/analysis/Sample_5/gatk/Sample_5_realignment_targets.list \
     -o /scratch/gencore/templates_git/data/analysis/Sample_5/gatk/Sample_5_realigned.withrg.csorted.cleaned.aligned.bam
...
#	SAM: {$self->samtools_dir}/{$sample}_withrg.csorted.cleaned.aligned.bam
...
#TASK tags=Sample_5
ln -s /scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_withrg.csorted.cleaned.aligned.bam /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_withrg.csorted.cleaned.aligned.bam && \
samtools index /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_withrg.csorted.cleaned.aligned.bam && \
samtools mpileup -ugf /scratch/Reference_Genomes/Public/Vertebrate_mammalian/Homo_sapiens/ENSEMBL-release-81-GRCh38/Homo_sapiens.GRCh38.dna.toplevel.fa \
    /scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_withrg.csorted.cleaned.aligned.bam | bcftools call -vmO z -o \
    /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_aligned.sorted.vcf.gz
...
#TASK tags=Sample_5
tabix -p vcf /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_aligned.sorted.vcf.gz
...
#TASK tags=Sample_5
bcftools stats -F /scratch/Reference_Genomes/Public/Vertebrate_mammalian/Homo_sapiens/ENSEMBL-release-81-GRCh38/Homo_sapiens.GRCh38.dna.toplevel.fa -s - /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_aligned.sorted.vcf.gz \
    > /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_aligned.sorted.vcf.stats
...
#TASK tags=Sample_5
bcftools filter -O z \
    -o /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_filteredQ10.aligned.sorted.vcf.gz \
    -s LOWQUAL -i'%QUAL>10' \
    /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_aligned.sorted.vcf.gz
...
#TASK tags=Sample_5
snpEff GRCh38.82 -v \
  -s /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_snpeff.filteredQ10.aligned.sorted.html \
  /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_filteredQ10.aligned.sorted.vcf.gz > /scratch/gencore/templates_git/data/analysis/Sample_5/samtools/Sample_5_snpeff.filteredQ10.aligned.sorted.vcf



#
# Ending bcftools_snpeff
#
...
# Variables 
# Indir: /scratch/gencore/templates_git/{$self->picard}
# Outdir: /scratch/gencore/templates_git/{$self->freebayes}
# Local Variables:
#	indir: {$self->picard}
#	outdir: {$self->freebayes}
#	INPUT: {$self->samtools_dir}/{$sample}_snpeff.filteredQ10.aligned.sorted.vcf
...
#TASK tags=Sample_5
mkdir -p /scratch/gencore/templates_git/data/analysis/Sample_5/freebayes && \
freebayes -f /scratch/Reference_Genomes/Public/Vertebrate_mammalian/Homo_sapiens/ENSEMBL-release-81-GRCh38/Homo_sapiens.GRCh38.dna.toplevel.fa \
  /scratch/gencore/templates_git/data/analysis/Sample_5/picard/Sample_5_withrg.csorted.cleaned.aligned.bam \
  > /scratch/gencore/templates_git/data/analysis/Sample_5/freebayes/Sample_5_freebayes_raw.vcf
...
#
# Variables 
# Indir: /scratch/gencore/templates_git/{$self->freebayes}
# Outdir: /scratch/gencore/templates_git/{$self->freebayes}
# Local Variables:
...
vcffilter -f "QUAL > 1 & QUAL / AO > 10 & SAF > 0 & SAR > 0 & RPR > 1 & RPL > 1" \
  /scratch/gencore/templates_git/data/analysis/Sample_5/freebayes/Sample_5_freebayes_raw.vcf > /scratch/gencore/templates_git/data/analysis/Sample_5/freebayes/Sample_5_filtered.freebayes.vcf
...
#TASK tags=Sample_5
snpEff GRCh38.82 -v \
  -s /scratch/gencore/templates_git/data/analysis/Sample_5/freebayes/Sample_5_snpeff.filtered.freebayes.html \
  /scratch/gencore/templates_git/data/analysis/Sample_5/freebayes/Sample_5_filtered.freebayes.vcf > /scratch/gencore/templates_git/data/analysis/Sample_5/freebayes/Sample_5_snpeff.filtered.freebayes.vcf



#
# Ending freebayes_snpeff
#
...
#	indir: {$self->picard}
#	outdir: {$self->gatk}
#	INPUT: {$self->freebayes_dir}/{$sample}_snpeff.filtered.freebayes.vcf
...
gatk -T HaplotypeCaller \
    ...
    -o /scratch/gencore/templates_git/data/analysis/Sample_5/gatk/Sample_5_haplotype.realigned.withrg.csorted.cleaned.aligned.vcf
...
gatk -T VariantFiltration \
    -R /scratch/Reference_Genomes/Public/Vertebrate_mammalian/Homo_sapiens/ENSEMBL-release-81-GRCh38/Homo_sapiens.GRCh38.dna.toplevel.fa \
    -I /scratch/gencore/templates_git/data/analysis/Sample_5/gatk/Sample_5_haplotype.realigned.withrg.csorted.cleaned.aligned.vcf \
    --filterExpression "QD '<' 2.0 || FS '>' 60.0 || MQ '<' 40.0 || MQRankSum '<' -12.5 || ReadPosRankSum '<' -8.0" \
    --filterName "my_snp_filter" \
    -o /scratch/gencore/templates_git/data/analysis/Sample_5/gatk/Sample_5_my_snp_filter.haplotype.realigned.mdup.csorted.cleaned.aligned.vcf
...
#	OUTPUT: {$self->gatk_dir}/{$sample}_snpeff.my_snp_filter.haplotype.realigned.mdup.csorted.cleaned.aligned.vcf
#	REPORT: {$self->gatk_dir}/{$sample}_snpeff.my_snp_filter.haplotype.realigned.mdup.csorted.cleaned.aligned.html
#	create_outdir: 0
#	before_meta: HPC DIRECTIVES
#
#HPC jobname=gatk_snpeff
...
#TASK tags=Sample_5
snpEff GRCh38.82 -v \
  -s /scratch/gencore/templates_git/data/analysis/Sample_5/gatk/Sample_5_snpeff.my_snp_filter.haplotype.realigned.mdup.csorted.cleaned.aligned.html \
  /scratch/gencore/templates_git/data/analysis/Sample_5/gatk/Sample_5_my_snp_filter.haplotype.realigned.mdup.csorted.cleaned.aligned.vcf > /scratch/gencore/templates_git/data/analysis/Sample_5/gatk/Sample_5_snpeff.my_snp_filter.haplotype.realigned.mdup.csorted.cleaned.aligned.vcf
...
#
# Variables 
# Indir: /scratch/gencore/templates_git/data/analysis/gatk_snpeff
# Outdir: /scratch/gencore/templates_git/data/analysis/remove_tmp
# Local Variables:
#	create_outdir: 0
#	before_meta: HPC DIRECTIVES
#
...
#	indir: /scratch/gencore/templates_git/data/analysis/gatk_snpeff
#	OUTPUT: {$self->gatk_dir}/{$sample}_snpeff.my_snp_filter.haplotype.realigned.mdup.csorted.cleaned.aligned.vcf
#	INPUT: {$self->gatk_dir}/{$sample}_snpeff.my_snp_filter.haplotype.realigned.mdup.csorted.cleaned.aligned.vcf
#

#TASK tags=Sample_5
#rm -rf /scratch/gencore/templates_git/data/analysis/Sample_5/bowtie2/tmp
